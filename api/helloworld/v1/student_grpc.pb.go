...
const (
	Student_Hello_FullMethodName         = "/api.helloworld.v1.Student/Hello"
	Student_CreateStudent_FullMethodName = "/api.helloworld.v1.Student/CreateStudent"
	Student_UpdateStudent_FullMethodName = "/api.helloworld.v1.Student/UpdateStudent"
	Student_DeleteStudent_FullMethodName = "/api.helloworld.v1.Student/DeleteStudent"
	Student_GetStudent_FullMethodName    = "/api.helloworld.v1.Student/GetStudent"
	Student_ListStudent_FullMethodName   = "/api.helloworld.v1.Student/ListStudent"
)
...
func (c *studentClient) Hello(ctx context.Context, in *HelloReq, opts ...grpc.CallOption) (*HelloResp, error) {
	...
	out := new(HelloResp)
	err := c.cc.Invoke(ctx, Student_Hello_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedStudentServer) ListStudent(context.Context, *ListStudentRequest) (*ListStudentReply, error) {
	return nil, status.Error(codes.Unimplemented, "method ListStudent not implemented")
}
...
func _Student_Hello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Student_Hello_FullMethodName,
	}
