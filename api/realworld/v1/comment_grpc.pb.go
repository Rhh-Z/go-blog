...
const (
	Comment_CreateComment_FullMethodName = "/api.realworld.v1.Comment/CreateComment"
	Comment_UpdateComment_FullMethodName = "/api.realworld.v1.Comment/UpdateComment"
	Comment_DeleteComment_FullMethodName = "/api.realworld.v1.Comment/DeleteComment"
	Comment_GetComment_FullMethodName    = "/api.realworld.v1.Comment/GetComment"
	Comment_ListComment_FullMethodName   = "/api.realworld.v1.Comment/ListComment"
)
...
var Comment_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "api.realworld.v1.Comment",
