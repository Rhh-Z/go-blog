...
const (
	Tag_CreateTag_FullMethodName = "/api.realworld.v1.Tag/CreateTag"
	Tag_UpdateTag_FullMethodName = "/api.realworld.v1.Tag/UpdateTag"
	Tag_DeleteTag_FullMethodName = "/api.realworld.v1.Tag/DeleteTag"
	Tag_GetTag_FullMethodName    = "/api.realworld.v1.Tag/GetTag"
	Tag_ListTag_FullMethodName   = "/api.realworld.v1.Tag/ListTag"
)
...
func (c *tagClient) ListTag(ctx context.Context, in *ListTagRequest, opts ...grpc.CallOption) (*ListTagReply, error) {
	...
	err := c.cc.Invoke(ctx, Tag_ListTag_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var Tag_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "api.realworld.v1.Tag",
