...
const (
	Profile_CreateProfile_FullMethodName   = "/api.realworld.v1.Profile/CreateProfile"
	Profile_UpdateProfile_FullMethodName   = "/api.realworld.v1.Profile/UpdateProfile"
	Profile_DeleteProfile_FullMethodName   = "/api.realworld.v1.Profile/DeleteProfile"
	Profile_GetProfile_FullMethodName      = "/api.realworld.v1.Profile/GetProfile"
	Profile_ListProfile_FullMethodName     = "/api.realworld.v1.Profile/ListProfile"
	Profile_FollowProfile_FullMethodName   = "/api.realworld.v1.Profile/FollowProfile"
	Profile_UnfollowProfile_FullMethodName = "/api.realworld.v1.Profile/UnfollowProfile"
)
...
func (c *profileClient) FollowProfile(ctx context.Context, in *FollowProfileRequest, opts ...grpc.CallOption) (*ProfileResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ProfileResponse)
	err := c.cc.Invoke(ctx, Profile_FollowProfile_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *profileClient) UnfollowProfile(ctx context.Context, in *UnfollowProfileRequest, opts ...grpc.CallOption) (*ProfileResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ProfileResponse)
	err := c.cc.Invoke(ctx, Profile_UnfollowProfile_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedProfileServer) ListProfile(context.Context, *ListProfileRequest) (*ListProfileReply, error) {
	return nil, status.Error(codes.Unimplemented, "method ListProfile not implemented")
}
func (UnimplementedProfileServer) FollowProfile(context.Context, *FollowProfileRequest) (*ProfileResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method FollowProfile not implemented")
}
func (UnimplementedProfileServer) UnfollowProfile(context.Context, *UnfollowProfileRequest) (*ProfileResponse, error) {
...
func _Profile_FollowProfile_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(FollowProfileRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ProfileServer).FollowProfile(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Profile_FollowProfile_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProfileServer).FollowProfile(ctx, req.(*FollowProfileRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Profile_UnfollowProfile_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UnfollowProfileRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ProfileServer).UnfollowProfile(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Profile_UnfollowProfile_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProfileServer).UnfollowProfile(ctx, req.(*UnfollowProfileRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Profile_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "api.realworld.v1.Profile",
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Profile_FollowProfile_Handler,
		},
		{
			MethodName: "UnfollowProfile",
			Handler:    _Profile_UnfollowProfile_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "realworld/v1/profile.proto",
}
